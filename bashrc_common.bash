...
export PYTHONPATH="$PYTHONPATH:$HOME/scripts/arrayAnalysisTools/pythonLib:$HOME/scripts/arrayAnalysisTools/projectLib:$HOME/scripts/array_fitting_tools/bin"
...
export pegasus_ip='anthony@171.65.21.230'
